...
<html>
	...
	*{margin:auto;padding:0;}
    ...
    <%
        String id = request.getParameter("kode_jadwal");
	...
	<p>
		<label>Hari</label>
		<% 
                    out.print("<input type='hidden' name='kode_jadwal' value='"+id+"'>"); 
	...
	<p>
		<label>Mata Pelajaran</label>
                <% 
                    out.print("<input type='text' name='mata_pelajaram' value='"+mata_pelajaran+"'>"); 
                %>
	</p>
	<p>
